    ...
    <div style={{ marginBottom: 16, background: "#FFFFFF", border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
      ...
      {hasMore && (
        <button
          ...
          style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "100%", padding: "10px 20px", fontFamily: MONO, fontSize: 12, fontWeight: 600, color: C.caret, background: C.surface, border: "none", borderTop: `1px solid ${C.border}`, cursor: "pointer", transition: "background 0.15s" }}
